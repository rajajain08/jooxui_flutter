...
class MusicOnboardingSecond extends StatefulWidget {
  MusicOnboardingSecond({Key key}) : super(key: key);

  _MusicOnboardingSecondState createState() => _MusicOnboardingSecondState();
}

class _MusicOnboardingSecondState extends State<MusicOnboardingSecond> {
